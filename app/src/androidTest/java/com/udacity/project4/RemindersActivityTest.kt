...
class RemindersActivityTest :
    ...
    fun savedReminder() = runBlocking {
        ...
        onView(withId(R.id.title)).check(ViewAssertions.matches(ViewMatchers.withText("title1")))

        onView(withId(R.id.description)).check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
        onView(withId(R.id.description)).check(ViewAssertions.matches(ViewMatchers.withText("describ1")))
    ...
    fun addReminder() {
        ...
        onView(ViewMatchers.withContentDescription("Google Map")).perform(longClick())
        ...
        onView(ViewMatchers.withText(R.string.reminder_saved))
            .inRoot(RootMatchers.withDecorView(Matchers.not(getActivity(activityScenario)?.window?.decorView)))
    ...
    fun Snackbar_NoTitle() {
        ...
        onView(withId(com.google.android.material.R.id.snackbar_action)).perform(click())
        onView(withId(R.id.saveReminder)).perform(click())
        onView(withId(com.google.android.material.R.id.snackbar_text)).check(ViewAssertions.matches(
            ViewMatchers.isDisplayed()))
        onView(withId(com.google.android.material.R.id.snackbar_text)).check(ViewAssertions.matches(
            ViewMatchers.withText(R.string.err_enter_title)))
    }
